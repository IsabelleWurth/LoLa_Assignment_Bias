...
X_test_premise = X_test_premise
y_train = y_train[:20000]
y_test = y_test

# function to calculate HO-features
def features(X_train_premise, y_train):
    ...
    for premise, label in zip(X_train_premise, y_train):
...
pmi_scores = features(X_train_premise, y_train)

# save PMI scores as json files (change filename for each dataset)
output_file_path = 'PO_pmi_scores_dataset.json'
