...
X_train_features = [extract_features(doc, pmi_scores, label) for doc, label in zip(X_train_hypothesis, y_train)]
X_test_features = [extract_features(doc, pmi_scores, label) for doc, label in zip(X_test_hypothesis, y_test)]
